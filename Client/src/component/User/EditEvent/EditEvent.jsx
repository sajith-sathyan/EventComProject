...
function  EditEvent(props) {
  ...
  const [eventTitle, setTitle] = useState(
    allEventData.BasicInfoData.eventTitle
  );
  const [organizerName, setOrganizerName] = useState(
    allEventData.BasicInfoData.organizerName
  );
  ...
  const [startDate, setStartDate] = useState(
    allEventData.BasicInfoData.startDate
  );
  const [startTime, setStartTime] = useState(
    allEventData.BasicInfoData.startTime
  );
  ...
  const [text, setText] = useState(allEventData.EvetnMeidaData.description);
  const [Image, setImage] = useState(null);
  const [url, setUrl] = useState(allEventData.EvetnMeidaData.eventImgUrl);
  const [summary, setSummary] = useState(allEventData.EvetnMeidaData.summary);
  ...
  useEffect(() => {
    ...
    getBookedUserDetials(allEventData.BasicInfoData.EventMediaId);
