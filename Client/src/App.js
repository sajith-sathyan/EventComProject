      ...
      {/* authentiactioin routes */}
       ...
       {/* home page */}
        ...
        <Route element={<UserRouteProtected/>}>
          ...
          <Route exact path="/organizations/home" element={<OrganizationsHome/>} />
          <Route exact path="/organizations/event" element={<OrganizationsEvent/>} />
          <Route exact path="/organizations/:id/editEvent" element={<EditEvent/>} />
          <Route exact path="/organizations/event/:id/createTicket" element={<CreateTickets/>} />
          <Route exact path="/organizations/event/:id/tickets" element={<Tickets/>} />
          <Route exact path="/organizations/event/:id/basicInfo" element={<EditBasicInfoPage/>} />
          <Route exact path="/organizations/statistics" element={<OrganizationsSidebar/>} />
       ...
       {/* admin Routes */}
       <AdminProtectedRoute  path="/admin/dashboard" element={<AdminDashboard/>} />
       <AdminProtectedRoute exact path="/admin/usermangement" element={<Dashboard/>} />
       <AdminProtectedRoute exact path="/admin/eventManagement" element={<ApproveEvent/>} />
       <AdminProtectedRoute exact path="/admin/categoryAndType" element={<CategoryAndType/>} /> 
...
//        <Route exact path="/admin/usermangement" element={<Dashboard/>} />
//        <Route exact path="/admin/eventManagement" element={<ApproveEvent/>} />
//        <Route exact path="/admin/categoryAndType" element={<CategoryAndType/>} /> 
//        <Route exact path="/admin/Login" element={<AdminLoginPage/>} /> 
